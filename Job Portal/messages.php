...
$tablesExist = true;
$requiredTables = ['messages', 'conversations'];
...
// Display a message if tables don't exist
if (!$tablesExist) {
    echo '<div class="bg-gray-50 py-8">';
    ...
    echo '<p><strong>System Notice:</strong> The messaging feature is currently being set up. Please check back later.</p>';
